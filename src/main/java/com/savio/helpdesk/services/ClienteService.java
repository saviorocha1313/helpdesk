...
import com.savio.helpdesk.domain.dtos.ClienteDTO;
...
public class ClienteService {
    ...
    @Autowired
    private BCryptPasswordEncoder encoder; // Importante para criptografar a senha!
    ...
    public Cliente update(Integer id, @Valid ClienteDTO objDTO) {
        ...
        // Se a senha mudou, criptografa novamente. Se é a mesma, mantém.
